...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--phase1-count", type=int, default=1500, help="phase1로 변환할 이미지 수")
    parser.add_argument("--phase3-count", type=int, default=2500, help="phase3로 변환할 이미지 수")
