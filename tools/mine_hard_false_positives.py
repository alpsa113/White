...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--conf", type=float, default=0.50, help="모델 후처리 confidence")
    parser.add_argument("--person-conf", type=float, default=0.50, help="person FP 채택 confidence")
